    ...
    <div className='w-full h-[580px] overflow-hidden rounded-2xl relative'>
        ...
        <div className='w-full absolute bottom-0 left-0 bg-gradient-to-t from-black p-5'>
          ...
          <div className='flex gap-3 mt-3 mb-5'>
            <button className='text-gray-800 text-lg font-bold bg-white hover:bg-cyan-500 hover:text-white transition-all duration-300 rounded-full px-4 py-2 flex items-center gap-2'><IoCaretForwardCircle/>Watch Now</button>
